...
function buildCommands(sources) {
  ...
  //
  // v1.5.13: each action also carries paralleled `labelKey` + `keywordsKey`
  // pointers into the WebUI i18n catalog (commandPalette.actions.<sub>.label
  // and .keywords). The renderer reads `label/keywords` for English-locale
  // UX + tests, but overlays them with `t(labelKey)/t(keywordsKey)` before
  // scoring + rendering when the user's locale is non-default. Hints here
  // are keyboard shortcut glyphs, not translatable.
  const actions = [
    {
      id: 'action:new-tab',
      label: 'New Tab',
      labelKey: 'commandPalette.actions.newTab.label',
      hint: '⌘T',
      keywords: 'open create blank',
      keywordsKey: 'commandPalette.actions.newTab.keywords',
      emoji: '➕',
    ...
    },
    {
      ...
      label: 'New Identity',
      labelKey: 'commandPalette.actions.newIdentity.label',
      hint: '⌥N',
      keywords: 'create persona profile account',
      keywordsKey: 'commandPalette.actions.newIdentity.keywords',
      emoji: '👤',
    ...
    },
    {
      ...
      label: 'Duplicate Tab',
      labelKey: 'commandPalette.actions.duplicateTab.label',
      hint: '⌥D',
      keywords: 'clone copy',
      keywordsKey: 'commandPalette.actions.duplicateTab.keywords',
      emoji: '⎘',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.reopenClosedTab.label',
      hint: '⇧⌘T',
      keywords: 'undo restore last',
      keywordsKey: 'commandPalette.actions.reopenClosedTab.keywords',
      emoji: '↩︎',
    ...
    },
    {
      ...
      label: 'Pin / Unpin Tab',
      labelKey: 'commandPalette.actions.togglePin.label',
      hint: '⌥P',
      keywords: 'fix sticky',
      keywordsKey: 'commandPalette.actions.togglePin.keywords',
      emoji: '📌',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.toggleLock.label',
      hint: '⌥L',
      keywords: 'protect freeze prevent close',
      keywordsKey: 'commandPalette.actions.toggleLock.keywords',
      emoji: '🔒',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.moveToNewWindow.label',
      hint: '⌥S',
      keywords: 'detach split',
      keywordsKey: 'commandPalette.actions.moveToNewWindow.keywords',
      emoji: '🪟',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.takeSnapshot.label',
      hint: '⇧⌘B',
      keywords: 'backup time machine save state',
      keywordsKey: 'commandPalette.actions.takeSnapshot.keywords',
      emoji: '📸',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.openTimeMachine.label',
      keywords: 'backup restore snapshots history',
      keywordsKey: 'commandPalette.actions.openTimeMachine.keywords',
      emoji: '⏱',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.openVault.label',
      keywords: 'accounts passwords credentials autofill',
      keywordsKey: 'commandPalette.actions.openVault.keywords',
      emoji: '🔐',
    ...
    },
    {
      ...
      label: 'Open Proxies',
      labelKey: 'commandPalette.actions.openProxies.label',
      keywords: 'proxy oxylabs ip network',
      keywordsKey: 'commandPalette.actions.openProxies.keywords',
      emoji: '🌐',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.openBrowsingData.label',
      keywords: 'bookmarks history downloads',
      keywordsKey: 'commandPalette.actions.openBrowsingData.keywords',
      emoji: '📚',
    ...
    },
    {
      ...
      label: 'Open Settings',
      labelKey: 'commandPalette.actions.openSettings.label',
      keywords: 'preferences config options',
      keywordsKey: 'commandPalette.actions.openSettings.keywords',
      emoji: '⚙️',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.openBulkOpener.label',
      hint: '⌥⇧O',
      keywords: 'multi account batch many open mass',
      keywordsKey: 'commandPalette.actions.openBulkOpener.keywords',
      emoji: '🎯',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.cloneIdentity.label',
      keywords: 'duplicate copy fingerprint sub-account variant',
      keywordsKey: 'commandPalette.actions.cloneIdentity.keywords',
      emoji: '📑',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.healthCheck.label',
      keywords: 'fingerprint proxy cookie timezone coherence audit safety',
      keywordsKey: 'commandPalette.actions.healthCheck.keywords',
      emoji: '🩺',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.manageExtensions.label',
      keywords: 'chrome web store ublock 1password addon plugin per identity',
      keywordsKey: 'commandPalette.actions.manageExtensions.keywords',
      emoji: '🧩',
    ...
    },
    {
      ...
      label: 'Notifications',
      labelKey: 'commandPalette.actions.openNotifications.label',
      keywords: 'alerts log history bell warnings',
      keywordsKey: 'commandPalette.actions.openNotifications.keywords',
      emoji: '🔔',
    ...
    },
    {
      ...
      labelKey: 'commandPalette.actions.toggleDevtools.label',
      hint: '⇧⌘J',
      keywords: 'inspector debug',
      keywordsKey: 'commandPalette.actions.toggleDevtools.keywords',
      emoji: '🛠',
  ...
  for (const i of identities) {
    ...
    out.push({
      ...
      // v1.5.13: paired with hint above so the renderer can translate the
      // role-name pill to the user's locale. label is built from i.name
      // (real identity data) so no labelKey is needed.
      hintKey: isActive ? 'commandPalette.hints.active' : 'commandPalette.hints.identity',
      subtitle: i.id === 'default' ? 'Default identity' : undefined,
      subtitleKey:
        i.id === 'default'
          ? 'commandPalette.fallbacks.defaultIdentitySubtitle'
          : undefined,
  ...
  for (const w of workspaces) {
    ...
    out.push({
      ...
      hintKey: isActive
        ? 'commandPalette.hints.active'
        : 'commandPalette.hints.workspace',
  ...
  for (const t of tabs) {
    ...
    out.push({
      ...
      hintKey: isFocused ? 'commandPalette.hints.focused' : 'commandPalette.hints.tab',
